...
/*
Esta clase esta hecho para hacer lo mismo que PanelCocacola, pero con la diferencia
que este esta hecho para el PanelComprador y hace lo contrario que PanelCocacola.
 */
public class PanelCocacolaC extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (mostrar1 && imagen1 != null){
            g.drawImage(imagen1, 10, 60, this);
        }
        if (mostrar2 && imagen2 != null){
            g.drawImage(imagen2, 60, 60, this);
        }
        if (mostrar3 && imagen3 != null){
            g.drawImage(imagen3, 110, 60, this);
        }
        if (mostrar4 && imagen4 != null){
            g.drawImage(imagen4, 160, 60, this);
        }
        if (mostrar5 && imagen5 != null){
            g.drawImage(imagen5, 210, 60, this);
        }
        if (mostrar6 && imagen6 != null){
            g.drawImage(imagen6, 260, 60, this);
        }
    }
