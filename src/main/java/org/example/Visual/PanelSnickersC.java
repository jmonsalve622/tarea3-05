...
/*
Esta clase esta hecho para hacer lo mismo que PanelSnickers, pero con la diferencia
que este esta hecho para el PanelComprador y hace lo contrario que PanelSnickers.
 */
public class PanelSnickersC extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (mostrar1 && imagen1 != null){
            g.drawImage(imagen1, 0, 180, this);
        }
        if (mostrar2 && imagen2 != null){
            g.drawImage(imagen2, 50, 180, this);
        }
        if (mostrar3 && imagen3 != null){
            g.drawImage(imagen3, 100, 180, this);
        }
        if (mostrar4 && imagen4 != null){
            g.drawImage(imagen4, 150, 180, this);
        }
        if (mostrar5 && imagen5 != null){
            g.drawImage(imagen5, 200, 180, this);
        }
        if (mostrar6 && imagen6 != null){
            g.drawImage(imagen6, 250, 180, this);
        }
    }
